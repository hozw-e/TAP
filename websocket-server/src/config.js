const config = {
  ...
  allowedOrigins: (process.env.WEBSOCKET_ALLOWED_ORIGINS || 'http://localhost:5173,http://localhost:3000,http://localhost:80')
    .split(',')
  ...
  phpSessionValidateUrl: process.env.PHP_SESSION_VALIDATE_URL || 'http://localhost:80/api/auth/validate-session.php',
